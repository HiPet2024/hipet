                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                PageWidget(
                                                  key: Key(
                                                      'Key52k_${listViewIndex}_of_${listViewPostsRecordList.length}'),
                                                  parameter1:
                                                      columnPostsRecord.fotos,
                                                  parameter2: columnPostsRecord
                                                      .reference,
                                                  parameter3: columnPostsRecord
                                                      .fotos.length,
                                                  parameter4:
                                                      columnPostsRecord.fotos,
                                                ),
